      ...
      <div class="content-wrapper">
        ...
        <?php if ($this->uri->segment(2) == 'home') { ?>
          <div class='alert alert-warning alert-dismissible fade in' role='alert'
            ...
            <a href="http://dev.rasxmedia.com/u/rasx" style="margin-right:10px; text-decoration:none;">Haloo Selamat
              datang di
              halaman administrator, Saat ini anda menggunakan WEBSITE ini</a>
            <a target='_BLANK' class="btn btn-default btn-sm" href="http://dev.rasxmedia.com/u/rasx"
              style="color: rgb(243, 156, 18);">WEBSITE Sekolah RizkiAgungId</a>
          </div>
        <?php } ?>
